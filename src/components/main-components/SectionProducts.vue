...
import CardProduction from "./CardProducts.vue"

export default {
    components: { CardText, CardProduction }
}
</script>
<template>
    <section id="products">
        <div class="row ">
            ...
            <CardProduction>
                <div class="my-card">
                    ...
                    <div class="on-hover">
                        ...
                        <div class="type">Cookies, Pastries</div>
            ...
            <CardProduction>
                <div class="my-card">
                    <img src="../../assets/images/strawberry-jam-cookies-400x510.jpg" alt="cookies" class="img-fluid">
